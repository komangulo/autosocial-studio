...
const Router = {
  init() {
    ...
    window.addEventListener("hashchange", () => {
      ...
      if (view && document.getElementById(`view-${view}`)) this.navigate(view);
    });
    const initial = location.hash.replace(/^#/, "");
    if (initial && document.getElementById(`view-${initial}`)) this.navigate(initial);
  },
